...
> **Demo recording?** Show the **summary table below** first, then scroll to **TC001** and **TC004** for the two live demos.

Generated: 2026-06-18 16:27 UTC  
Source: `assignment/test_cases.json` (12 assignment cases)  
**Summary: 12/12 matched expected outcomes**
...
**Reason:** Partial approval: covered procedures approved; cosmetic/excluded items rejected. Teeth Whitening: COSMETIC_EXCLUSION
...
**6. policy_engine** — `PARTIAL`
   Partial approval: covered procedures approved; cosmetic/excluded items rejected. Teeth Whitening: COSMETIC_EXCLUSION
   ```json
   {
  "rejection_reasons": [],
...
**Reason:** Pre-authorization required for high-value MRI/CT/PET diagnostic tests above ₹10,000 but was not obtained. Please obtain pre-authorization and resubmit.
...
**5. submission_validator** — `SUCCESS`
  ...
  "document_hospital_names": []
   ...
   ```
**6. policy_engine** — `REJECTED`
   Pre-authorization required for high-value MRI/CT/PET diagnostic tests above ₹10,000 but was not obtained. Please obtain pre-authorization and resubmit.
   ```json
   {
  "rejection_reasons": [
    "PRE_AUTH_MISSING"
...
**5. submission_validator** — `SUCCESS`
  ...
  "document_hospital_names": []
   ...
   ```
**6. policy_engine** — `REJECTED`
   Treatment falls under policy exclusions (obesity/weight loss programs).
   ```json
   {
  "rejection_reasons": [
    "EXCLUDED_CONDITION"
